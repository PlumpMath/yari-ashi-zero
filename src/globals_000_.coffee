...
dom_stuff = {p, strong, pre, div, h1, h2, h3, h4, h5, h6, span, svg, circle, rect, ul, line, li, ol, code, a, input, defs, clipPath, body, linearGradient, stop, g, path, d, polygon, image, pattern, filter, feBlend, feOffset, polyline, feGaussianBlur, feMergeNode, feMerge, radialGradient, foreignObject, text, textArea, ellipse, pattern} = React.DOM
...
window.tooltip_000 = rc_generic(require('./components/shared/tooltip_000_.coffee'))

window.theme_chooser_000 = rc_generic(require('./components/shared/theme_chooser_000_.coffee'))
