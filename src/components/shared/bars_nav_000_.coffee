        ...
        svg1(
            ...
            g {onMouseLeave: @fade_me, opacity: @state.my_opacity, onMouseEnter: @cancel_fade_me},
                ...
                if @state.tooltip_lights is true
                    tooltip {opacity: @state["opacitytooltip_lights"], x: sun_place.x, y: sun_place.y, font_size}
                ...
                if @state.tooltip_home is true
                    tooltip {opacity: @state["opacitytooltip_home"], x: home_place.x, y: home_place.y, font_size}
                    # svg1(
                    #     rect
                    #         x: "#{home_place.x}%"
                    #         y: "#{home_place.y - 4}%"
